...
if __name__ == '__main__':
    ...
    bg.calc_full_yll(sheet_name='Covid_19_combined_without_unk')
    # Generate datasets for the 40-64 age groups for Czechia and Bulgaria.
    cz.calc_full_yll(start_age=40, end_age=64)
    bg.calc_full_yll(start_age=40, end_age=64, sheet_name='Covid_19_combined_without_unk')
    # Calculate WYLL for Bulgaria and Czechia, assuming a cut-off age of 65.
    bg.calc_full_yll(sheet_name='Covid_19_combined_without_unk', mode='WYLL')
